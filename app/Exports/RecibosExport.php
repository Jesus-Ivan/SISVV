        ...
        foreach ($this->recibos as $key => $recibo) {
            ...
            foreach ($this->metodos_pago as $metodo) {
                ...
                $data[] = [
                    ...
                    'BAR' => $this->totalConcepto($detalles_filtrados, "^(?!PROPINA)(.*)(BAR LOUNGE|\d+ - BAR)$"),
                    'CADDIE' => $this->totalConcepto($detalles_filtrados, "^(?!PROPINA)(.*)(CADDIE|CADDIE BAR)$"),
                    'CAFETERIA' => $this->totalConcepto($detalles_filtrados, "^(?!PROPINA)(.*)(CAFETERIA|CAFETERÍA)$"),
                    'LOCKERS' => $this->totalConcepto($detalles_filtrados, "^(?!PROPINA)(.*)(LOCKERS|LOCKER CABALLEROS|LOCKER DAMAS)$"),
