<x-app-layout>
    ...
    <!-- Title -->
    <h4 class="text-2xl font-bold dark:text-white m-3">CARGAR PERIODO COMPROBACIONES</h4>
    {{-- Contenido --}}
    <form class="mx-4" action="{{ route('administracion.cargar-comp') }}" method="POST" enctype="multipart/form-data">
        @csrf
        {{-- Selector de fecha --}}
        ...
        <div class="max-w-lg">
            ...
            <input
                ...
                aria-describedby="comprobaciones_help" id="comprobaciones" name="comprobaciones" type="file"
                required>
