<x-app-layout>
    ...
    <div class="flex justify-center" x-data="{
        ...
        <form class="max-w-3xl" action="{{ route('almacen.documentos.existencias') }}" method="POST" target="_blank"
            id="reporte-form">
            @csrf
            {{-- BARRA DE BUSQUEDA --}}
            <div class="flex m-2 gap-4">
                <div class="flex gap-2 items-center">
                    <input type="number" placeholder="Folio de requisicion" id="folio" name="folio"
