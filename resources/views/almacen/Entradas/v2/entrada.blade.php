<x-app-layout>
    ...
    <div class="pt-3">
        <div class="flex ms-3">
            <div class="inline-flex flex-grow ">
                <div>
                    ...
                    <div id="dropdownDots"
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                            ...
                            <li>
                                <a href="{{ route('almacen.entradav2.nueva') }}"
                ...
                <h4 class="flex items-center ms-2 text-2xl font-bold dark:text-white">ENTRADA DE ARTICULOS v2</h4>
            </div>
    ...
    <div>
        <livewire:almacen.entradas.v2.principal />
    </div>
</x-app-layout>
