<x-app-layout>
    ...
    <div class="container py-3">
        <div class="flex ms-2">
            <button x-data x-on:click="$dispatch('open-modal', { name: 'añadirMr' })"
            ...
            <h4 class="flex items-center ms-2 text-2xl font-bold dark:text-white">MERMAS</h4>
        </div>
    </div>

    <div>
        <livewire:almacen.mermas.principal />
    </div>
