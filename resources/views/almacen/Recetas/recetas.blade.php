    ...
    <div class="py-5">
        <div class="flex ms-3">
            <div class="inline-flex flex-grow">
                <a type="button" href="{{ route('almacen.recetas.nueva') }}"
                ...
                <h4 class="flex items-center ms-2 text-2xl font-bold dark:text-white">Platillos Vista Verde</h4>
            </div>
        </div>
    </div>

    <div>
        <livewire:almacen.recetas.principal />
    </div>
