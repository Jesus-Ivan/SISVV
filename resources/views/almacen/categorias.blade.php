<x-app-layout>
    ...
    <div class="container py-5">
        <div class="flex ms-3">
            ...
            <h4 class="flex items-center ms-2 text-2xl font-bold dark:text-white">Lista de categorías</h4>
        </div>
    </div>
                    ...
                    <form class="p-4 md:p-5">
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <div class="col-span-2">
                                <label for="name"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre de la categoría</label>
