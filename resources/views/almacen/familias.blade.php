<x-app-layout>
    ...
    <div class="container py-5">
        <div class="flex ms-3">
            <button x-data x-on:click="$dispatch('open-modal', { name: 'añadirFm' })"
            ...
            <h4 class="flex items-center ms-2 text-2xl font-bold dark:text-white">Lista de familias</h4>
        </div>
    </div>

    <div>
        <livewire:almacen.tabla-familias />
    </div>
