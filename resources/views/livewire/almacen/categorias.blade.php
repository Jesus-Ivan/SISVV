<div>
    ...
    @if ($accionesCategoria)
        <x-modal name="modificarCt" title="EDITAR CATEGORÍA">
            ...
            <x-slot:footer>
                <button type="button" wire:click="updateCat({{ $categorias }})"
    ...
    @if ($accionesCategoria)
        <x-modal name="eliminarCt" title="ELIMINAR CATEGORÍA">
            ...
            <x-slot:footer>
                <button type="button" wire:click="confirmDelete({{ $categorias }})"
    ...
    @if ($accionesCategoria)
        <x-modal name="reingresarCt" title="REINGRESAR CATEGORÍA">
            ...
            <x-slot:footer>
                <button type="button" wire:click="confirmReingreso({{ $categorias }})"
