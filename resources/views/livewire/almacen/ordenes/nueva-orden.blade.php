<div>
    ...
    <div class="container py-5">
        <div class="flex ms-3">
            ...
            <div class="inline-flex">
                <label for="name"
                    class="ms-2 flex items-center text-sm font-medium text-gray-900 dark:text-white">FOLIO:
                </label>
                <input type="text" id="disabled-input" aria-label="disabled input"
                    class="ms-2 bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
    ...
    <x-modal name="modal-articulos" title="AÑADIR ARTICULO A LA LISTA">
        <x-slot name='body'>
            ...
            <div class="h-auto max-w-4xl overflow-y-auto">
                ...
                <!-- Modal footer -->
                <div
                    class="flex items-center space-x-3 rtl:space-x-reverse border-t border-gray-200 rounded-b dark:border-gray-600">
