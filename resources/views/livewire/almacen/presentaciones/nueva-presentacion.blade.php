<div>
        ...
        <div>
            ...
            <div class="flex gap-2 w-full">
                <div class="w-full">
                    ...
                    <input type="text" id="clave" wire:model='form.clave'
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="1235" disabled />
                </div>
                <div class="w-full">
            ...
            <div class="flex gap-2 w-full">
                <div class="w-full">
                    ...
                    <input type="number" id="iva" step="0.01" wire:model='form.iva'
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="16%" />
                </div>
                <div class="w-full">
                    <label for="c_c_impuesto" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Costo
                        con inpuesto</label>
                    <input type="number" id="c_c_impuesto" step="0.01"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="$0.00" />
                </div>
            </div>
                ...
                <div class="flex gap-2 items-end">
                    <div class="w-full">
                        <label for="insumo_base"
                            ...
                            Base</label>
                        <input type="text" id="insumo_base" wire:model='form.insumo_base' disabled
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="#" />
    ...
    <div class="px-4 py-2">
        ...
        <a type="button" wire:click='guardarNuevo'
    ...
    <!--INDICADOR DE CARGA-->
    <div wire:loading wire:target='guardarNuevo'>
