        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr
                    ...
                    <th scope="row" class="w-24 px-3 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        9854
                    </th>
                    <td class="px-3 py-2">
                        2025-11-11
                    ...
                    <td class="px-3 py-2">
                        se ocupo para el evento de XV años
                    </td>
                    <td class="px-3 py-2">
                        <div class="flex">
                            <div>
                                <a type="button" wire:click='showDetails( $item->folio )'
                                    ...
                                    <div wire:loading.remove wire:target='showDetails( $item->folio)' class="flex">
                                        Detalles
                                    </div>
                                    <!--Loading indicator-->
