<div>
    ...
    <div class="inline-flex flex-grow">
        <div class="max-w-sm">
            <select id="tipo_busqueda"
                class="ms-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-fit p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    @foreach ($listaPlatillos as $platillos)
                        <tr wire:key={{ $platillos->folio }}
                            class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <td class="px-6 py-4 uppercase">
                                <div class="flex items-center gap-4">
                                    <div class="dark:text-white">
                                        <div class="font-medium"> {{ $platillos->nombre }} </div>
                                        <p class="text-sm text-gray-500 dark:text-gray-400"> {{ $platillos->descripcion }}</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 uppercase">
                            ...
                            <td class="max-w-fit px-6 py-4">
                                @if ($platillos->estado == '1')
                                    <div class="flex">
                                        ...
                                        <a href="{{ route('almacen.recetas.editar') }}">
                                            <button type="button"
                                                class="ms-2 text-blue-700 border border-blue-700 hover:bg-blue-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:focus:ring-blue-800 dark:hover:bg-blue-500">
                                        ...
                                        <button type="button" wire:click="delete({{ $platillos->codigo }})"
                                ...
                                @else
                                    <button type="button"
                                        wire:click="reingresar({{ $platillos->codigo }})"
    ...
    @if ($cartaPlatillos)
        <x-modal name="eliminarPlat" title="ELIMINAR PLATILLO">
            <x-slot:body>
                <div class="text-center">
                    ...
                    <h3 class="mb-5 text-xl font-normal text-gray-500 dark:text-gray-400">¿Desea eliminar
                        {{ $cartaPlatillos->nombre }}?
                    </h3>
                    <p class="text-gray-500 dark:text-gray-400">El platillo no se eliminara de la base de datos, solo
    ...
    @if ($cartaPlatillos)
        <x-modal name="reingresarPlat" title="REINGRESAR PLATILLO">
            <x-slot:body>
                <div class="text-center">
                    <svg class="mx-auto mb-4 text-gray-400 w-12 h-12 dark:text-gray-200" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
