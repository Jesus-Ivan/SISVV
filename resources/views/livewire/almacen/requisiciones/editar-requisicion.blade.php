    ...
    <div class="p-2.5">
        <div class="flex ">
            ...
            <div class="inline-flex flex-grow">
                ...
                <h4 class="flex items-center ms-2 text-2xl font-bold dark:text-white">NUEVA REQUISICION</h4>
            </div>
            {{-- FECHA Y FOLIO --}}
            ...
            <div class="h-auto max-w-4xl overflow-y-auto">
                ...
                <div class="grid gap-2 grid-cols-3">
                    ...
                    <div class="col-span-1">
                        <select id="proveedor" wire:model='id_grupo'
