<div>
    ...
    <div class="py-5">
        <div class="flex ms-3">
            <div class="inline-flex flex-grow">
                <button x-data x-on:click="$dispatch('open-modal', { name: 'nuevaSalida' })"
                ...
                <h4 class="flex items-center ms-2 text-2xl font-bold dark:text-white">Nueva salida de artículos</h4>
            </div>
    ...
    <div class="inline-flex">
        ...
        <div class="col-span-1">
            <label for="salida" class="mb-2 text-sm font-medium text-gray-900 dark:text-white">Origen:</label>
    ...
    <x-modal name="nuevaSalida" title="SALIDA DE ARTICULO">
        {{-- MODAL BODY --}}
        <x-slot:body>
            <livewire:almacen.salidas.modalSalidas />
        </x-slot>
    </x-modal>
    <!--Alerts-->
