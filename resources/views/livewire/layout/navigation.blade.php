...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-12">
                        ...
                        <ul class="space-y-2 font-medium">
                            ...
                            <li>
                                <a href="{{ route('acceso') }}"
                                    ...
                                    <span class="flex-1 ms-3 whitespace-nowrap">Entrada Portico</span>
                                </a>
                            </li>
                            <li>
                                <button type="button"
                                    ...
                                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Punto de
                                        venta</span>
                                ...
                                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                                    ...
                                    <li>
                                        <a href="{{ route('pv.index', ['codigopv' => 'LOD']) }}"
                                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Lockers
                                            Damas</a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                <a href="{{ route('recepcion') }}"
                                    ...
                                    <span class="flex-1 ms-3 whitespace-nowrap">Recepción</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('sistemas') }}"
                                    ...
                                    <span class="flex-1 ms-3 whitespace-nowrap">Sistemas</span>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <!-- User name -->
            <div class="shrink-0 flex items-center" x-data="{{ json_encode(['name' => auth()->user()->name]) }}" x-text="name"
