<div class="ms-3 mx-3" @keyup.ctrl.window="$dispatch('open-modal', {name:'modal-productos'})">
    ...
    {{-- BOTON DE CANCELAR --}}
    <a href="{{ route('pv.solicitud-mercancia', ['codigopv' => $codigopv]) }}" wire:navigate
                        ...
                        <div class="inline-flex gap-2">
                            ...
                            <div class="relative">
                                <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                                    <svg wire:loading.delay.remove wire:target="searchInsumo"
                                    ...
                                    <!--Loading indicator-->
                                    <div wire:loading.delay wire:target='searchInsumo'>
                                        @include('livewire.utils.loading', ['w' => 5, 'h' => 5])
                                    </div>
                                </div>
                                <input type="text" wire:model.live.debounce.500ms="searchInsumo"
