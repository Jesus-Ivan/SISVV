<div x-data="{
    ...
    guardar() {
        ...
        for (i = 0; i < $wire.gruposModif.length; i++) {
            ...
            let modif_seleccionados = this.selected.filter(modif => modif.id_grupo == grupo_i.id_grupo);
            if (grupo_i.forzar_captura == 1 && modif_seleccionados.length == 0) {
