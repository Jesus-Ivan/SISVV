<div>
    ...
    <div class="shadow-md sm:rounded-lg">
        ...
        <div class="pb-4 w-full bg-white dark:bg-gray-900">
            ...
            <div class="relative mt-1">
                ...
                <input type="text" id="table-search" wire:model.live.debounce.500ms ="ventaForm.seachProduct"
                            ...
                            <td class="w-4 p-4">
                                <div class="flex items-center">
                                    <input id="checkbox-{{ $producto->codigo }}" 
                                        wire:model="ventaForm.selected.{{ $producto->codigo }}"
                                        type="checkbox"
    ...
    <div class="flex items-center mt-4 border-t border-gray-200 rounded-b dark:border-gray-600">
        <button data-modal-hide="modal-productos" type="button" wire:click='finishSelect'
