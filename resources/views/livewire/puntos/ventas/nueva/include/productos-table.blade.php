                        ...
                        <td class="px-6 py-4">
                            ...
                            @else
                                <input type="number" id="cantidad" min="0" max="100"
                                    ...
                                    wire:change.debounce.300ms="updateQuantity({{ $productoIndex }}, $event.target.value)"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <span class="sr-only">modificadores</span>
                            ...
                            @else
                                <button type="button" wire:click='transferir({{ $productoIndex }})'
                                    class="text-gray-900 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-2 py-2 text-center me-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800">
