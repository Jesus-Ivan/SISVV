<div>
    ...
    <div class="flex gap-2 items-start m-2">
        {{-- Barra de busqueda --}}
        <div class="w-96">
            <div class="relative">
            ...
            <tbody>
                @foreach ($this->recibos as $index => $recibo)
                    <tr wire:key="{{ $index }}"
                        ...
                        <td class="px-6 py-2">
                            <a type="button" href="{{ route('recepcion.cobros.recibo', $recibo->folio) }}"
                                target="_blank"
