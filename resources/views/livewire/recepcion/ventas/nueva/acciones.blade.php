<div>
    ...
    <div>
        <button type="button" wire:click='datos'
            ...
            <svg class="w-6 h-6 dark:text-gray-800 text-white me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
        ...
        <button type="button" wire:click="$dispatch('get-datos')"
        ...
        <x-primary-button wire:click='verDatos'>ver datos</x-primary-button>
    </div>
    <!--Alerts-->
