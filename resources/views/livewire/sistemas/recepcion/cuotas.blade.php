<div class="ms-3 mx-3">
    ...
    <div class="relative w-96">
        ...
        <input wire:model.live.debounce.500ms="search" type="search" id="search"
            ...
            placeholder="Buscar Cuota" required />
    </div>
    <div class="my-3">
        {{-- TABLA DE CUOTAS --}}
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    @foreach ($this->cuotas as $detalles)
                        <tr wire:key=''
                            class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                            @if ($this->editar_id == $detalles->id)
                                <th scope="row"
                                ...
                                <td class="px-3 py-2">
                                    ...
                                    <div class="dark:text-white">
                                        <input type="text" id="descripcion" wire:model='editar_descripcion'
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-96 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                                ...
                                <td class="px-3 py-2">
                                    <!-- TIPO -->
                                    <div class="dark:text-white">
                                        <input type="text" id="descripcion" wire:model='editar_tipo'
                                ...
                                <td class="px-3 py-2">
                                    <!-- MONTO -->
                                    <div class="dark:text-white">
                                        <input type="number" id="descripcion" wire:model='editar_monto'
                                ...
                                <td class=" px-3 py-2 text-center">
                                    <button type="button" wire:click='confirmarEdit({{ $detalles->id }})'
                            ...
                            @else
                                ...
                                <td class="px-3 py-2 text-center">
                                    <button type="button" wire:click='editCuota({{ $detalles->id }})'
            ...
            <div class="block w-full justify-end">{{ $this->cuotas->links() }}</div>
        </div>
    </div>
    <!--Alerts-->
