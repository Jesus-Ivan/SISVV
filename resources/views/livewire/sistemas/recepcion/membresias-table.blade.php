<div>
    <div class="ms-3 mx-3">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 max-w-full">
                            DESCRIPCION
                        </th>
                ...
                <tbody>
                    @foreach ($listaMembresias as $membresia)
                        <tr wire:key={{ $membresia->clave }}
        ...
        <div class="w-full my-2 flex justify-end">{{ $listaMembresias->links() }}</div>
    </div>

    <x-modal name="añadir" title="AÑADIR MEMBRESIA">
        <x-slot:body>
